...
public class OfficerDutyUpdateTest extends AcmeEndeavoursTest{
	...
	@Order(10)
	public void updateDutyPositive(final int recordIndex, final String title, final String description, final String periodInitial, final String periodFinal, final String workload, final String link, final Boolean isPublic) {
